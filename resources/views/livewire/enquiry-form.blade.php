    ...
    <div class="card-body" id="enquiry_form">
        ...
        <form wire:submit.prevent="submitdetails()" class="needs-validation" novalidate>
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-floating mb-3 has-validation">
                        <input type="tel" class="form-control numeric" wire:model="contact_no" id="MobileNo"
                ...
                <div class="col-12 mb-3">
                    <div class="form-floating">
                        <textarea class="form-control h-auto" rows="9"  maxlength="255" wire:model="message" autocomplete="off" placeholder="Leave a comment here" id="floatingTextarea"></textarea>
